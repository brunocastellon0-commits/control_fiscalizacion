...
class ParametroPlazoSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $plazos = [
            ...
            ['reglamento_id' => $ac022->id, 'tipo_plazo' => 'PLANIFICACION', 'subtipo' => null, 'dias_habiles' => 2, 'base_legal' => 'AC_022_2018', 'activo' => true],
            ['reglamento_id' => $ac022->id, 'tipo_plazo' => 'EJECUCION', 'subtipo' => 'JURISDICCIONAL', 'dias_habiles' => 10, 'base_legal' => 'AC_022_2018', 'activo' => true],
            ['reglamento_id' => $ac022->id, 'tipo_plazo' => 'EJECUCION', 'subtipo' => 'ADMINISTRATIVA', 'dias_habiles' => 15, 'base_legal' => 'AC_022_2018', 'activo' => true],
            ['reglamento_id' => $ac022->id, 'tipo_plazo' => 'EJECUCION_AMPLIADA', 'subtipo' => null, 'dias_habiles' => 5, 'base_legal' => 'AC_022_2018', 'activo' => true],
            ['reglamento_id' => $ac054->id, 'tipo_plazo' => 'EVALUACION', 'subtipo' => null, 'dias_habiles' => 5, 'base_legal' => 'AC_054_2018', 'activo' => true],
            ['reglamento_id' => $ac054->id, 'tipo_plazo' => 'PLANIFICACION', 'subtipo' => null, 'dias_habiles' => 2, 'base_legal' => 'AC_054_2018', 'activo' => true],
            ['reglamento_id' => $ac055->id, 'tipo_plazo' => 'EVALUACION', 'subtipo' => null, 'dias_habiles' => 5, 'base_legal' => 'AC_055_2018', 'activo' => true],
            ['reglamento_id' => $ac055->id, 'tipo_plazo' => 'PLANIFICACION', 'subtipo' => null, 'dias_habiles' => 2, 'base_legal' => 'AC_055_2018', 'activo' => true],
