...
class ComunicarHallazgosRequest extends FormRequest
{
    /**
     * E7-S* (RN-09): solo el Auditor Financiero activo con la bandeja del
     * expediente puede comunicar hallazgos (politica comunicarHallazgos).
     */
    public function authorize(): bool
    {
        $expediente = $this->expedienteDeRuta();

        return $expediente !== null && $this->user()->can('comunicarHallazgos', $expediente);
    }

    /**
     * El oficio de comunicación de hallazgos es obligatorio: la fase exige
     * respaldo documental estricto (AC055).
     *
    ...
    {
        return [
            'descripcion.required' => 'La descripción de la comunicación es obligatoria.',
            'descripcion.min' => 'La descripción debe tener al menos :min caracteres.',
            'adjunto.required' => 'Debe adjuntar el oficio de comunicación de hallazgos.',
