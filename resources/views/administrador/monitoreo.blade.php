            ...
            <div class="lg:col-span-2">
                ...
                <div class="relative mt-1">
                    ...
                    <input
                        ...
                        placeholder="NUREJ o descripción..."
                    ...
                    <template x-for="exp in expedientes" :key="exp.id">
                        ...
                        <tr class="hover:bg-gris-claro/30">
                            ...
                            <td class="px-4 py-4">
                                ...
                                <p class="text-xs text-gris max-w-[250px] truncate"
                                   x-text="exp.descripcion"></p>

                                <p class="text-[10px] text-gris mt-1"
                                   x-text="'Ingreso: ' + exp.fecha_ingreso">
                                </p>
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            <div class="w-7 h-7 rounded-full
                                                ...
                                                <i
                                                    :class="exp.responsable.rol === 'AUDITOR'
                                                        ? 'fa-solid fa-user-shield'
                                                        : 'fa-solid fa-user-gear'"
                                                    class="text-xs text-verde-profundo">
                                                </i>
                            ...
                            <td class="px-4 py-4">
                                ...
                                <template x-if="exp.designacion">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-grafito"
                                           x-text="exp.designacion.fecha">
                                        </p>
                                        ...
                                        <p class="text-xs font-medium text-grafito"
                                           x-text="exp.designacion.por">
                                        </p>
                            ...
                            <td class="px-4 py-4 min-w-[180px]">
                                ...
                                <div x-show="exp.plazo">
                                    ...
                                    <p class="text-[10px] text-gris mt-1"
                                       x-text="'Límite: ' + exp.plazo.fecha_limite">
                                    </p>

                                </div>

                                <span x-show="!exp.plazo"
                                      class="text-xs text-gris">
                                    Sin plazo
                                </span>
...
function monitoreoExpedientes() {
    ...
    return {
        ...
        async cargar() {
             ...
             * Posteriormente:
             *
             * GET /api/administrador/monitoreo
             *
             * con los filtros.
             */
            ...
            this.expedientes = [
                {
                    id: 1,
                    nurej: 'EXP-2026-00125',
                    descripcion: 'Proceso de control y fiscalización',
                ...
                {
                    id: 2,
                    nurej: 'EXP-2026-00118',
                    descripcion: 'Revisión de documentación',
                    fecha_ingreso: '20/08/2026',
                ...
                {
                    id: 3,
                    nurej: 'EXP-2026-00110',
                    descripcion: 'Expediente pendiente de asignación',
            ...
            this.resumen = {
                ...
                sin_asignar: this.expedientes.filter(x => x.estado === 'SIN_ASIGNAR').length,
                en_tramite: this.expedientes.filter(x => x.estado === 'EN_TRAMITE').length,
                por_vencer: this.expedientes.filter(x => x.estado === 'POR_VENCER').length,
                fuera_plazo: this.expedientes.filter(x => x.estado === 'FUERA_DE_PLAZO').length
            };
        },
